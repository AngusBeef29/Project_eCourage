...
public class IntroSlidersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderManager = new SliderManager(this, "introSlider");
        session = new SessionManager(IntroSlidersActivity.this);


        if(!sliderManager.Check()){
            sliderManager.setFirst(false);
            if (session.isLoggedIn()) {
                Intent i = new Intent(IntroSlidersActivity.this, MainActivity.class);
                startActivity(i);
                finish();
            } else {
                Intent i = new Intent(IntroSlidersActivity.this, LoginActivity.class);
                startActivity(i);
                finish();
            }
